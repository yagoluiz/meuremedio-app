...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_remedio_mock__ = __webpack_require__(261);
...
var RemedioApi = /** @class */ (function () {
    function RemedioApi(http) {
        this.http = http;
        this.API_URL = 'https://ec2-18-188-196-175.us-east-2.compute.amazonaws.com:8443/api/';
    }
    RemedioApi.prototype.getByNome = function (remedio) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.http.get(this.API_URL + "consulta?value=" + remedio).toPromise()];
                    case 1:
                        response = _a.sent();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_providers__ = __webpack_require__(200);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__mocks_providers_remedios_mock__ = __webpack_require__(158);
